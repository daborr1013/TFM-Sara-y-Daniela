    ...
    <div class="chat-container">
        ...
        <div class="chat-box" id="chatBox" aria-live="polite" aria-atomic="false">
            <div class="message bot">
                <p>¡Hola! Estoy listo para ayudarte con Jane Eyre. Pregúntame por personajes, capítulos, símbolos, temas o contexto histórico.</p>
            </div>
        </div>

        <form class="chat-input-area" id="chatForm">
            <label for="messageInput" class="sr-only">Mensaje de chat</label>
            <input type="text" id="messageInput" placeholder="Escribe tu pregunta..." required aria-label="Mensaje de chat">
