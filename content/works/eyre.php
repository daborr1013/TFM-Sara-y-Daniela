        ...
        <div class="layout">
            <div class="sidebar">
                <nav class="navbar-sidebar">
                    <ul class="menu-sidebar">
                        ...
                        <li class="dropdown-sidebar">
                            <a href="eyre_content.php/contexto_eyre.php">Contexto</a>
                            <ul class="dropdown-menu-sidebar">
                                <li><a href="eyre_content.php/charlotte.php">Charlotte Brontë</a></li>
                                <li><a href="eyre_content.php/contexto_historico.php">Contexto histórico</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown-sidebar">
                            <a href="eyre_content.php/actividades_eyre.php">Actividades</a>
                            <ul class="dropdown-menu-sidebar">
            ...
            <section class="pjustificado">
                <section class="layout">
                    ...
                    <img src="../../media/images/portadaJane.png" width="30%" alt="Portada de Jane Eyre">
                </section>

                <p>Y no te olvides de <a href="../litto.php">Litto</a>, él puede ayudarte a resolver tus preguntas.
                </p>
                ...
                <p>Te recomendamos comenzar conociendo más sobre el <a
                    ...
                    contamos con
                    un <a href="eyre_content.php/glosario.php">glosario</a> que te puede ayudar con términos que
                    puedan
