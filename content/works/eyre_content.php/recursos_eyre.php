                ...
                <section class="layout">
                    <section class="pjustificado">
                        <p>Aquí podrás acceder a distintos recursos que te explican partes
                            importantes de la obra. En la sección <a href="simbolosTemas.php">temas y símbolos</a>
                            dispondrás de
                            análisis de elementos clave, como el fuego y el hielo, cuya interpretación resulta
                            fundamental para
                            entender profundamente <i>Jane Eyre</i>.</p>
                    </section>
                    <img class="actividades" src="../../../media/images/recursos.png" alt="Imagen de recursos">
