        ...
        <div class="layout">
            ...
            <section class="pjustificado">
                ...
                <section class="pjustificado">
                    ...
                    <p>Tras huir de Thornfield con apenas unas pocas monedas, Jane se ve obligada a gastar lo último que
                        tiene en un carruaje
                        que la deja en un lugar remoto llamado Whitcross. Sin dinero, sin comida y sin techo, Jane vive
                    ...
                    <p>En un estado de agotamiento extremo y bajo una lluvia torrencial, Jane sigue una luz en el páramo
                        que la lleva hasta una casa
                        llamada Marsh End (o Moor House). A través de la ventana, observa a dos mujeres cultas, Diana y
                        Mary, y a su criada Hannah. Cuando intenta pedir ayuda,
                        Hannah la rechaza confundiéndola con una vagabunda común. Justo cuando Jane se desploma
                        aceptando su muerte, aparece St. John Rivers, el hermano de las
                        jóvenes y clérigo del lugar, quien la rescata citando la voluntad de Dios. Los tres hermanos la
                        acogen, le dan alimento y calor, mientras Jane, para
                ...
                <section class="pjustificado">
                    ...
                    <p>Jane baja a la cocina y tiene un pequeño enfrentamiento con Hannah, la sirvienta, quien la juzga
                        por su apariencia de mendiga.
                        Jane, con su característica dignidad, le da una lección de moral: le recuerda que la pobreza no
                    ...
                    <p>Cuando St. John le pide que cuente su historia, Jane (bajo el pseudónimo de Jane Elliott) les
                        ...
                        de donde viene. St. John acepta su secreto y le promete
                ...
                <section class="pjustificado">
                    ...
                    <p>Jane entabla una amistad profunda con Diana y Mary. Las tres comparten el amor por la lectura y
                        el estudio (especialmente de idiomas como el alemán).
                        Jane admira su independencia y su intelecto, sintiéndose por primera vez tratada como una igual
                        en un entorno familiar sano.
                        Sin embargo, St. John sigue siendo un enigma: es un hombre entregado a su deber religioso, pero
                        Jane nota que no es feliz; parece devorado por una ambición
                    ...
                    <p>St. John finalmente le encuentra un trabajo a Jane. Le ofrece ser la maestra de una escuela para
                        niñas pobres en el pueblo de Morton.
                        El salario es bajo y el trabajo humilde, pero Jane acepta con gratitud porque le ofrece lo que
                        más desea: independencia total.</p>
                </section>

                <section class="pjustificado">
                    <a class="boton" href="../caps/4.Moor House (Cap. 28–35)/cap31.php">Capítulo XXXI</a>

                    <p>Jane inaugura su escuela con solo veinte alumnas, de las cuales solo tres saben leer. Al
                        ...
                        Rochester, verse enseñando el abecedario en una aldea rural le
                    ...
                    <p>En este capítulo aparece un personaje clave: Rosamond Oliver, la hija del hombre más rico de la
                        ...
                        hermosa que Jane ha visto jamás" (incluso más que Blanche Ingram). Ella llega a la escuela y su
                        presencia ilumina el lugar. Jane observa con atencián
                        la reacción de St. John Rivers ante ella, ya que es evidente que ambos se atraen pero St.John se
                ...
                <section class="pjustificado">
                    ...
                    <p>Jane gana el respeto y el cariño de sus alumnas en Morton, descubriendo que incluso las niñas más
                        humildes tienen talentos ocultos.
                        Su vida es tranquila, pero sus noches están llenas de sueños vívidos y dolorosos con Rochester.
                    </p>
                    <p>Rosamond Oliver visita la escuela con frecuencia, claramente buscando encontrarse con St. John.
                        Un día, Jane se ofrece a hacerle un
                        retrato a lápiz a Rosamond. Mientras trabaja, St. John llega y queda cautivado por la imagen.
                        Jane, valiente y directa, aprovecha la oportunidad para
                        confrontarlo. St. John explica que su verdadera vocación es ser misionero en la India. Sabe que
                        ...
                        considera su deber sagrado.</p>
                </section>

                <section class="pjustificado">
                    <a class="boton" href="../caps/4.Moor House (Cap. 28–35)/cap33.php">Capítulo XXXIII</a>

                    <p>En una noche de tormenta de nieve, St. John Rivers llega a la cabaña de Jane. Tras un preámbulo
                        lleno de tensión, le cuenta una
                        historia que parece salida de un libro: habla de una tal Jane Eyre, una institutriz que
                        desapareció de Thornfield Hall tras un intento de boda ilegal
                        con el Sr. Rochester. St. John revela cómo la encontró: el trozo de papel que arrancó en el
                    ...
                    <p>Lo más conmovedor para Jane no es el dinero. Al hacer preguntas sobre la familia de St. John,
                        descubre la verdad definitiva:
                        el padre de St. John, Diana y Mary era el hermano de la madre de Jane. Los River son sus primos.
                ...
                <section class="pjustificado">
                    ...
                    <p>Tras repartir la herencia, las hermanas Diana y Mary regresan a Moor House, y por primera vez en
                        su vida, Jane disfruta de un hogar
                        lleno de afecto y libertad económica. Sin embargo, St. John no se permite disfrutar. Se vuelve
                        cada vez más exigente con Jane, pidiéndole que deje de
                        estudiar alemán y aprenda hindustani, preparándola para su misión en la India</p>
                    <p>Jane se siente anulada por la voluntad de hierro de su primo. Ella describe su influencia como
                        una "neblina helada" que apaga su
                        chispa natural. El clímax del capítulo llega cuando St. John le hace una propuesta de
                    ...
                    <p>Jane acepta ir a la India como su "hermana" o colaboradora, pero se niega a casarse con él. Ella
                ...
                <section class="pjustificado">
                    ...
                    <p>Tras el rechazo de Jane, St. John utiliza su arma más poderosa: la culpa religiosa. Durante una
                        semana, la trata con una frialdad gélida
                        que hace que Jane se sienta como una pecadora ante Dios. Diana intenta advertirle que casarse
                        con él sería una locura, pero St. John redobla su presión.</p>
                    <p>Una noche, St. John reza con tal fervor y autoridad que Jane se siente al borde de la rendición.
                        ...
                        en el silencio absoluto de la noche, Jane escucha una voz conocida que la llama, pero no es una
                        voz que está en su cabeza, la está oyendo realmente.
                        Reconoce al instante que es la voz de Edward Rochester.</p>
                    <p>Este fenómeno le devuelve la fuerza y la claridad. Rompe el hechizo de St. John, lo aparta y
