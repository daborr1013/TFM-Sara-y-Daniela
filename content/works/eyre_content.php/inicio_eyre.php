...
<head>
    <meta charset="UTF-8">
    <title>Litterally-Eyre-Inicio</title>
...
<main id="main">
    ...
    <div class="layout">
        ...
        <section class="pjustificado">
            <p>Bienvenido al entorno de <i>Jane Eyre</i>. Aquí podrás conocer más acerca de la vida de <a href="charlotte.php">Charlotte Brontë</a>,
            ...
            <p>También podrás descubrir los significados ocultos tras elementos como la "habitación roja", el fuego y el hielo, la 
                naturaleza, o incluso el mismo nombre de la protagonista. En la sección de <a href="personajes.php">personajes</a>, la encontrarás 
            ...
            <p>Te recomendamos comenzar conociendo más sobre el <a href="contexto_historico.php">contexto histórico</a> para así comprender
            las limitaciones a las que se enfrenta Jane a lo largo de la historia. Ten en cuenta que también contamos con
            un <a href="glosario.php">glosario</a> que te puede ayudar con términos que puedan llegar a dificultar tu comprensión. ¿Qué mejor 
            para terminar que unas cuantas frases célebres? En <a href="citas.php">citas</a> podrás encontrarlas todas.</p>
        </section>
    </div>
</main>
